...
# 출력은 기본값을 output_pretrain_2 / log_dir 도 output_pretrain_2 로 둠.
import datetime
import os
import sys
import json
...
def get_args():
    ...
    ap.add_argument("--mom_weight",   default=0.3,  type=float,
                    help="MOM 항 가중치 (기본 0.3). POC/POM이 안 줄면 더 낮춤(0.1 등)")
    ...
    ap.add_argument("--output_dir",   default="./output_pretrain_2")
    ap.add_argument("--log_dir",      default="./output_pretrain_2")
