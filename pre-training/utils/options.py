...
def get_args_parser_pretrain():
    ...
    parser.add_argument('--exptype', default='main_2', type=str,
    ...
    # Dataset parameters
    parser.add_argument('--data_dir', default='./datasets/datasets_multimodal_pretrain.pkl',
    ...
    if task == "pre-train":
        file_handler = logging.FileHandler(
            filename=os.path.join(args.output_dir,
                                  "log-{}-{}-{}.log".format(args.exptype, task, now.strftime("%Y-%m-%d %H:%M:%S"))))
    else:
