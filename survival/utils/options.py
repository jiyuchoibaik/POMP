...
def get_args_parser_finetune():
    ...
    parser.add_argument('--exptype', default='test1', type=str,
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='../pre-training/output_finetune_dir/checkpoint-poc_mom-100.pth',
    ...
    # Dataset parameters
    parser.add_argument('--data_dir', default='./datasets/lihc_cv_splits.pkl',
    ...
    parser.add_argument('--output_dir', default='./output_finetune_dir/ablation_loss',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_finetune_dir/ablation_loss',
